  ...
  return (
    <section id="portfolio" className="bg-black text-white py-20 px-6 md:px-12">
      ...
      <div className="text-center mt-12">
        <a
          href="/AllProjects"
         className="inline-block text-white mt-5 px-6 py-2 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 text-white font-semibold text-sm hover:shadow-lg hover:shadow-purple-500/40 transition-all"

        >
          <span className="text-white ">Browse All Projects</span>
        </a>
      </div>
